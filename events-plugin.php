...
*/
	...
	public function __construct() {
		...
		add_action ('add_meta_box', array($this, 'events_create'));
		add_action ('init', array($this, 'events_meta'));
		add_filter ('manage_edit_events_columns', array($this, 'events_edit_columns'));
